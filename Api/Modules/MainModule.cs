  ...
  public class MainModule : Nancy.NancyModule
  {
    ...
    public MainModule(ILogger<MainModule> logger, IDataAccessRegistry dataAccessRegistry)
    {
      ...
      Get("/", x =>
      {
        ...
        var last = temps.Last();
        var insideInt = last.Inside != 0f ? last.Inside.ToString().Split(".")[0] : "0";
        var insideRest = last.Inside != 0f ? last.Inside.ToString().Split(".")[1] : "0";
        var outsideInt = last.Outside != 0f ? last.Outside.ToString().Split(".")[0] : "0";
        var outsideRest = last.Outside != 0f ? last.Outside.ToString().Split(".")[1] : "0";
